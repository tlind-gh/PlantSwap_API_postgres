...
public class UserController {
    ...
    @PostMapping("/list")
    public ResponseEntity<List<User>> addMultipleUsers(@Valid @RequestBody List<User> userList) {
        return new ResponseEntity<>(userService.createMultipleUsers(userList), HttpStatus.CREATED);
    }
